...
To test whether symbolic attitudes and material self-interest each contribute to the formation of policy preferences, we will use joint F-tests. 
...
Hence, the restricted model will be $y_i = \beta_0 + \textbf{X}_{i2}\beta_2 +  \textbf{X}_{i3}\beta_3 + \epsilon_i$.
...
Hence, the restricted model will be $y_i = \beta_0 + \textbf{X}_{i1}\beta_1 +  \textbf{X}_{i3}\beta_3 + \epsilon_i$.
